		...
		var option_html = '<div id="option_script" style="display:none;text-align:center;" >'
				...
				+ '<div class="sectionOptions" id="choix_var">'
					...
					+ '<tr></tr><tr></tr><tr><td colspan="4" class="titre_interne"><strong> '+ text.selec_scan_st +'</strong></td></tr>'
						+ '<tr><td><label for="val_res_min" >• '+ text.q_apartir +' </label></td><td><input type="text" id="val_res_min" value="'+ nb_scan_accpte +'" style="width:50px;" /> '+text.apartir + ' (Y)</td></tr>'
				...
				+ '<div class="sectionOptions" id="color_ligne">'
					...
					+ '<tr><td><label for="att2">• '+ text.attt +' 2nd vague'+iconeNew('Version 8.0')+'</label> </td><td><input id="att2" type="text" class="att" value="'+ stockageOption.get('couleur attaque2') +'" style="width:60px;background-color:'+ stockageOption.get('couleur attaque2') +';" /></td><td><input id="att2_r" type="text" class="att_r" value="'+ stockageOption.get('couleur attaque2 retour') +'" style="width:60px;background-color:'+ stockageOption.get('couleur attaque2 retour') +';" /></td></tr>'
					...
					+ '<tr><td><label for="colEspio">• '+ localization.missions[6] +' '+iconeNew('Version 8.0')+'</label> </td><td><input id="colEspio" type="text" value="'+ stockageOption.get('couleur espionnage') +'" style="width:60px;background-color:'+ stockageOption.get('couleur espionnage') +';" /></td></tr>'
					+'</table>'
				+ '</div>'
				...
				+ '<div class="sectionOptions" id="choix_affichage">'
					...
					+ '<tr></tr><tr></tr><tr><td colspan="4" class="titre_interne"><strong> '+ text.changement_boutondroite +'  </strong></td></tr>'
						...
						+ '<tr><td><label>• Le lien attaquer s\'ouvre dans '+iconeNew('Version 8.0')+'</label></td><td><select id="rf_attaquer_ouvredans" style="width:210px;"><option value="1"'+(stockageOption.get('attaquer nouvel onglet') === 1 ? ' selected':'')+'>L\'onglet actuel</option><option value="2"'+(stockageOption.get('attaquer nouvel onglet') === 2 ? ' selected':'')+'>Un nouvel onglet</option><option value="3"'+(stockageOption.get('attaquer nouvel onglet') === 3 ? ' selected':'')+'>Toujours le même nouvel onglet</option></select></td></tr>'
